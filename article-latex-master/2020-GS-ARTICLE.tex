...
%---------------------------------------------------------- TITLE & SUBTITLE ---
\newcommand{\mytitle}{Decodifica stereo comparativa}
\newcommand{\mysubtitle}{comparazione di diverse decodifiche ambisonic}
%----------------------------------------------------------------- AUTHOR(s) ---
\newcommand{\authorone}{Kevin Manolli}
\newcommand{\institutione}{Conservatorio G. Nicolini di Piacenza}
\newcommand{\emailone}{kevin.manolli @ conservatorio.piacenza.it}
%-------------------------------------------------------------------------------
\newcommand{\authortwo}{Giuseppe Silvi}
\newcommand{\institutiontwo}{Conservatorio G. Nicolini di Piacenza}
\newcommand{\emailtwo}{giuseppe.silvi @ conservatorio.piacenza.it} % duplicate these 3 lines if more
%-------------------------------------------------------------- STYLE GS2020 ---
\input{gs2020.tex}
%------------------------------------------------------------ BEGIN DOCUMENT ---
\begin{document}
